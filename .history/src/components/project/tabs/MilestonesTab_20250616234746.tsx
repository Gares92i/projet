...
export const MilestonesTab = ({
  ...
  const handleEditMilestone = (milestone: ProjectMilestone) => {
    ...
    setFormValues({
      ...
      inProgress: milestone.inProgress
    });
    setIsDialogOpen(true);
  };
  ...
  const handleSaveMilestone = () => {
    ...
    if (onDataUpdate) {
      ...
      // Fallback direct au service si onDataUpdate n'est pas fourni
      const projectId = milestones[0]?.projectId || "unknown";
      updateProjectMilestones(projectId, updatedMilestones);
    }
