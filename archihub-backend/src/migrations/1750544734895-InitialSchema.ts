...
export class InitialSchema1750544734895 implements MigrationInterface {
    name = 'InitialSchema1750544734895'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_clerk" ADD "clerk_id" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "projects" ALTER COLUMN "name" TYPE character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_clerk" DROP COLUMN "clerk_id"`);
        await queryRunner.query(`ALTER TABLE "users_clerk" DROP COLUMN "updated_at"`);
        await queryRunner.query(`ALTER TABLE "users_clerk" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "users_clerk" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "users_clerk" DROP COLUMN "clerk_user_id"`);
